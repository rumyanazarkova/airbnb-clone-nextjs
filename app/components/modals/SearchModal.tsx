...
const SearchModal = () => {
    ...
    let bodyContent = (
        <div className="flex flex-col gap-8">
            <Heading title="Where d yuo want to go?" subtitle="Find the perfect location!" />
    ...
    if(step===STEPS.INFO){
        bodyContent=(
            <div className="flex flex-col gap-8">
                ...
                <Counter title='Bathrooms' subtitle="How many bathrooms you need?" value={bathroomCount} onChange={(value)=>setBathroomCount(value)} />
            </div>
        )
    }
